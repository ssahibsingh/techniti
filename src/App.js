...
import { Avishkar, BestFromWaste, Boltbolt, ChemECar, ChemEDesign, ChemEHunt, FashionShow, Hackmol, IntegrationBee, Microrobowar, Prayaas, RCcars, Robohunt, Robowar, ThreeBHK, TrickyCircuits, UAVDrone } from "./Events";
      ...
      <Router>
        ...
        <ScrollToTop>
          <Routes>
            ...
            <Route path="/event/best-from-waste" element={<BestFromWaste />} exact />
            <Route path="/event/chem-e-car" element={<ChemECar />} exact />
            <Route path="/event/chem-e-design" element={<ChemEDesign />} exact />
            <Route path="/event/chem-e-hunt" element={<ChemEHunt />} exact />
            <Route path="/event/fashion-show" element={<FashionShow />} exact />
            <Route path="/event/hackmol" element={<Hackmol />} exact />
            <Route path="/event/integratio-bee" element={<IntegrationBee />} exact />
